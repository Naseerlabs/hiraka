    ...
    <div className="w-full max-w-sm">
      <form onSubmit={handleEmailSubmit} className="space-y-4">
        <input
          ...
          required
          className="w-full px-4 py-3 rounded-xl border border-zinc-200 bg-white text-sm focus:outline-none focus:ring-2 focus:ring-rose-200 transition-all"
        />
        <input
          type="password"
...
export default function AuthPage() {
  return (
    <main className="relative min-h-screen flex flex-col items-center justify-center p-6 overflow-hidden">
      <Silk className="opacity-20" speed={0.15} color="#e8789a" />
